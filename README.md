...
`//192.168.1.XXX/NASm2 /media/NASm2 cifs credentials=/etc/samba/credenziali-server,uid=1000,gid=1000,iocharset=utf8,_netdev,x-systemd.device-timeout=30,vers=3.0,actimeo=30,rsize=65536,wsize=65536 0 0`  
